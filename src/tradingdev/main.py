...
Usage::
    ...
    uv run python -m tradingdev.main --config configs/kd_strategy.yaml
"""
...
from tradingdev.backtest.report import (
...
from tradingdev.utils.cache import save_cached_result
...
def _merge_dvol(
    ...
    if not dvol_processed.exists():
        from tradingdev.domain.data.crawlers.deribit_dvol import (
            DeribitDVOLCrawler,
        )
