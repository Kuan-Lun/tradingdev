...
Launch::
    ...
    streamlit run src/quant_backtest/dashboard/app.py \
        -- --config configs/xgboost_strategy.yaml

Requires a cached PipelineResult produced by::

    python -m quant_backtest.main --config configs/xgboost_strategy.yaml
"""
...
from quant_backtest.dashboard.analysis import (  # noqa: E402
    available_months,
    build_equity_series,
    build_trades_df,
...
from quant_backtest.utils.cache import load_cached_result  # noqa: E402
