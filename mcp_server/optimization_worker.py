...
Invoked by the MCP server as a detached subprocess:
    ...
    python mcp_server/optimization_worker.py <job_id>
...
from mcp_server.backtest_worker import (  # noqa: E402
    _create_engine,
...
from quant_backtest.utils.parallel import estimate_n_jobs  # noqa: E402
...
def _evaluate_combo(
    ...
    from mcp_server.backtest_worker import (
        _create_engine,
        _load_strategy_class,
        _serialize_metrics,
    )
    from quant_backtest.data.schemas import BacktestConfig
