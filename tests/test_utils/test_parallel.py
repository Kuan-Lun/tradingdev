...
from tradingdev.utils.parallel import (
...
class TestGetPerformanceCoreCount:
    ...
    def test_fallback_on_non_darwin(self) -> None:
        ...
        with patch("tradingdev.utils.parallel.platform") as mock_platform:
    ...
    def test_fallback_on_sysctl_failure(self) -> None:
        ...
        with (
            patch("tradingdev.utils.parallel.platform") as mock_platform,
            patch("tradingdev.utils.parallel.subprocess") as mock_subprocess,
        ):
